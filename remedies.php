<?php
$data = file_get_contents('https://NeutralizeCarbon.neeltron.repl.co/output');
$arr = explode("\n", $data);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="./css/remedies.css">
</head>
    ...
    <main>
        ...
        <div class="row">
            <div class="card shadow" style="width: 18rem;">
                <div class="container">
                    <svg class="tree" id="animation" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 302.7 436.37">
                        <defs>
                            ...
                            <g id="leaf-rb">
                                <g>
                                    <path
                                        ...
                                        transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_2)" />
                                    <path
                                        ...
                                        transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_3)" />
                                </g>
                                <path
                            ...
                            <g id="leaf-rm">
                                <g>
                                    <path
                                        ...
                                        transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_3-2)" />
                                    <path
                                        ...
                                        transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_2-2)" />
                                </g>
                                <path
                            ...
                            <g id="leaf-lb">
                                ...
                                <g>
                                    <path
                                        ...
                                        transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_2-4)" />
                                    <path
                                        ...
                                        transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_3-3)" />
                                </g>
                                <path
                            ...
                            <g id="leaf-lm">
                                <g>
                                    <path
                                        ...
                                        transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_2-5)" />
                                    <path
                                        ...
                                        transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_3-4)" />
                                </g>
                                <path
                            ...
                            <g id="main">
                                <g id="leaf-top">
                                    ...
                                    <path
                                        ...
                                        transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_3-5)" />
                                </g>
                                <path id="stem"
                                    ...
                                    transform="translate(-1.14 -2.3)" fill="url(#Dégradé_sans_nom_39)" />
                            </g>
                        </g>
                    </svg>
                </div>
                <div class="card-body dist1">
                    <h5 class="card-title">Grow <?php echo $arr[0]; ?>s</h5>
                    <p class="card-text">To neutralize your carbon footprint, you'll have to grow at least <?php echo $arr[2]; ?> trees.</p>
                    <a href="#" class="btn btn-success">Booyeahhh!!</a>
                </div>
            </div>
            <div class="card shadow" style="width: 18rem;">
                <lord-icon src="https://cdn.lordicon.com/hovbgwmd.json" trigger="loop"
                    colors="primary:#121331,secondary:#08a88a"
                    style="width: 340px;height: 340px;padding-top: 50px;padding-right: 50px;">
                </lord-icon>
